...
public class JBlockModel extends PieceModel {
    ...
    public JBlockModel() {
        ...
        this.blocks.add(new Block(new Position(3, 1), this.color, 5));
        this.blocks.add(new Block(new Position(4, 1), this.color, 6));
        this.blocks.add(new Block(new Position(5, 1), this.color, 7));
