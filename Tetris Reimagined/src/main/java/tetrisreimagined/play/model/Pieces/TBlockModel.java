...
public class TBlockModel extends PieceModel {
    ...
    public TBlockModel() {
        ...
        this.blocks.add(new Block(new Position(4, 1), this.color, 5));
        this.blocks.add(new Block(new Position(5, 1), this.color, 6));
        this.blocks.add(new Block(new Position(2, 0), this.color, 7));
        this.blocks.add(new Block(new Position(3, 0), this.color, 8));*/

        this.blocks.add(new Block(new Position(0, 2), this.color, 1));
        this.blocks.add(new Block(new Position(1, 2), this.color, 2));
        this.blocks.add(new Block(new Position(2, 1), this.color, 3));
        this.blocks.add(new Block(new Position(3, 1), this.color, 4));
        this.blocks.add(new Block(new Position(4, 2), this.color, 5));
        this.blocks.add(new Block(new Position(5, 2), this.color, 6));
        this.blocks.add(new Block(new Position(2, 0), this.color, 7));
        this.blocks.add(new Block(new Position(3, 0), this.color, 8));
        ...
        this.blocks.add(new Block(new Position(4, 3), this.color, 13));
        this.blocks.add(new Block(new Position(5, 3), this.color, 14));
