...
public class OBlockModel extends PieceModel {
    ...
    public OBlockModel() {
        ...
        this.blocks.add(new Block(new Position(2, 2), this.color, 3));
        this.blocks.add(new Block(new Position(3, 2), this.color, 4));

        this.blocks.add(new Block(new Position(0, 3), this.color, 5));
        this.blocks.add(new Block(new Position(1, 3), this.color, 6));
